            ...
            body: (
                <MathJax.Provider>
                    <div className="mathJaxContainer">
                        ...
                        <img className="smallImage" src={images.flag.blueprint} alt="blueprint" />
            ...
            body: (
                <React.Fragment>
                    ...
                    <div className="multipleImages">
                        <img className="verySmallImage" src={images.flag.model1} alt="model1" />
                        <img className="verySmallImage" src={images.flag.model2} alt="model2" />
                    </div>
                </React.Fragment>
            )
        },
