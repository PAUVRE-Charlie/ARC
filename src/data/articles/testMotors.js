	...
	body: {
        ...
        needs: {
            ...
            body: <React.Fragment>
               ...
               <ul>
                ...
                <img className="smallImage" src={images.testMotors.robotshop} alt="robotshop" />
        ...
        experience: {
			...
			<div className="multipleImages">
				<img src={images.testMotors.disk} style={{width: '40%'}} alt="disk"/>
				<img src={images.testMotors.shelf} style={{width: '40%'}} alt="shelf"/>
			</div>
			...
			<img className="mediumImage" src={images.testMotors.experience} alt="experience"/>
            </React.Fragment>
        },
        conclusion: {
            title: 'Conclusion',
