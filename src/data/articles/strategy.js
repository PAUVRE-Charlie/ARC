	...
	body:{
        introduction: {
            ...
            body: (
                <React.Fragment>
                    <h4>L'aire de jeu:</h4>
                    <img className="mediumImage" src={images.strategy.table_blueprint} alt="table_blueprint" />
                    <img className="mediumImage" src={images.strategy.table_upView} alt="table_upView" />
