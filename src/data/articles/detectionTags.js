        ...
        introduction: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="smallImage" src={images.detectionTags.tag} alt="tag"/>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <img className="smallImage" src={images.detectionTags.tag_cases} alt="tag_cases"/>
                        </li>
            ...
            body: (
                <React.Fragment>
                    ...
                    <div className="multipleImages">
                        <img className="mediumImage" src={images.detectionTags.compass} alt="compass"/>
                        <img className="smallImage" src={images.detectionTags.compass_tag} alt="compass_tag"/>
                    </div>
        ...
        equipment: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="smallImage" src={images.detectionTags.equipment} alt="equipment"/>
                </React.Fragment>
            )
        },
        code: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="smallImage" src={images.detectionTags.tag1} alt="tag1"/>
                    <p>On a ensuite les positions après des rotations successives dans le sens horaire de 90°, 180° et 270°.</p>
                    <div className="multipleImages">
                        <img src={images.detectionTags.tag2} className="smallImage" alt="tag2"/>
                        <img src={images.detectionTags.tag3} className="smallImage" alt="tag3"/>
                        <img src={images.detectionTags.tag4} className="smallImage" alt="tag4"/>
                    </div>
                    ...
                    <img className="smallImage" src={images.detectionTags.charuco_board} alt="charuco_board"/>
        ...
        demonstration: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <div className="multipleImages" >
                        <img className="smallImage" src={images.detectionTags.demo1} alt="demo1"/>
                        <img className="smallImage" src={images.detectionTags.demo2} alt="demo2"/>
                    </div>
                    <h4>Résultats</h4>
                    <img className="veryBigImage" src={images.detectionTags.results} alt="results"/>
                    <h4>Remarques</h4>
