        ...
        map: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="mediumImage" src={images.themeCup.table_blueprint} alt="table_blueprint" />
                    <h4>Les matchs</h4>
        ...
        mission1: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="mediumImage" src={images.themeCup.table_upView} alt="table_upView" />
                    ...
                    <img className="bigImage" src={images.themeCup.shuffle_buoy} alt="shuffle_buoy" />
                    <h4>Les bouées et leur position</h4>
                    <ul>
                    ...
                    <img className="bigImage" src={images.themeCup.validity_buoy} alt="validity_buoy" />
                    <h4>En bref</h4>
        ...
        mission2: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="mediumImage" src={images.themeCup.table_windsock} alt="table_windsock" />
        ...
        mission3: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="bigImage" src={images.themeCup.table_sweep} alt="table_sweep" />
                    <h4>Comptage des points</h4>
                    <ul>
        ...
        mission4: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="bigImage" src={images.themeCup.table_zones} alt="table_zones" />
                    ...
                    <img className="mediumImage" src={images.themeCup.compass} alt="compass" />
                    <h4>Comptage des points</h4>
                    ...
                    <img className="bigImage" src={images.themeCup.validity_robot} alt="validity_robot" />
        ...
        mission5: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="mediumImage" src={images.themeCup.robot_positions} alt="robot_positions" />
                    <h4>Comptage des points</h4>
                    <ul>
