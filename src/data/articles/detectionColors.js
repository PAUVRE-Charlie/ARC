        ...
        needs: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="smallImage" src={images.detectionColor.harbor} alt="harbor"/>
                ...
                <React.Fragment>
                    ...
                    <ul>
                        <li>
                            ...
                            <img className="smallImage" src={images.detectionColor.sensor_TCS3200} alt="TCS3200"/>
                        ...
                        <li>Capteur de couleur RGB, TCS34725<br/>
                            <img className="smallImage" src={images.detectionColor.sensor_TCS34725} alt="TCS3200"/>
                    ...
                    <img className="mediumImage" src={images.detectionColor.table_sensors} alt="table_sensors" />
        ...
        code: {
            ...
            body: (
                <React.Fragment>
                    ...
                    <img className="mediumImage" src={images.detectionColor.arduino} alt="arduino" />
                    ...
                    <img className="bigImage" src={images.detectionColor.code} alt="code" />
